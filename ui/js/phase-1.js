...
$(function() {
  ...
  $('#run-phase-1').click(function() {
    ...
    child = exec(command, args, function(err, stdout, stderr) {
      ...
      var ll = JavaCompilerPath + 'bin/ll.txt';
      ...
      $('#output .nav').append('<li role="presentation"><a href="#ll" aria-controls="ll" role="tab" data-toggle="tab">LL(1) Grammar</a></li>');
      $('#output .tab-content').append('<div role="tabpanel" class="tab-pane" id="ll"> <div id="ll-editor" class="editor" style="height:700px;margin-bottom:5px"></div> </div>');
      ...
      llEditor.setTheme("ace/theme/monokai");
      var llEditorSession = llEditor.getSession();
      llEditorSession.setUseWrapMode(true);
      llEditorSession.setWrapLimit(100);
      llEditor.setReadOnly(true);
